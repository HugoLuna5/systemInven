    ...
    <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            ...
            <div class="be-right-navbar">
                ...
                <div class="page-title"><span>Agregar Clientes</span></div>
    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb page-head-nav">
                <li><a href="{{url("/add-client")}}">Clientes</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Agregar un cliente<span class="panel-subtitle">Rellena los campos para agregar a un cliente</span></div>
                        <div class="panel-body">
                            <form action="{{url("/add-client")}}" method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Nombre completo</label>
                                    <div class="col-sm-6">
                                        <input type="text" required name="nombre" autocomplete="off" class="form-control input-lg">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" required name="direccion" class="form-control input-lg">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel"required name="telefono" class="form-control input-lg">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="sexo" required>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-7">
                                        <input type="submit" class="btn btn-rounded btn-space btn-success btn-xl" value="Agregar cliente">
                                    </div>
                                </div>
                            </form>
                        </div>
